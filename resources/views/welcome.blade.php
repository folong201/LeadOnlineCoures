            ...
            <div class="carousel-inner">
                <div class="carousel-item active" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Best Online Courses For Leader</h5>
                            <h1 class="display-3 text-white mb-md-4">Best Education From Your Dashboard</h1>
                ...
                <div class="carousel-item" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Best Online Courses</h5>
                            <h1 class="display-3 text-white mb-md-4">New Way To Learn From Dashboard</h1>
                            <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5" id="about">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="http://www.luciduniversity.org/wp-content/uploads/2019/02/Drshu-182x300.png" alt="">
                </div>
                <div class="col-lg-7">
                    ...
                    <p>
                        Lead higher institute, forerunner of LEAD University, is a professional institute of higher learning geared at grooming a new breed of professionally qualified and spiritually matured leaders for the African community and beyond. Its vision, its birth from a burden to see Africa emancipated from poor leadership, power abuse, incompetence, remote controlled neocolonialism and other vices.

                        Despite Africa’s naturally endowed riches in all domains and after more than half a century of independence of its states it continuous to waddle in misery, poverty, corruption, underdevelopment and pandemics.  LEAD comes in with a mandate to give expert training with lots of field   experiences in other to break the old molds of  training job seekers to building leaders who would no longer depend on western benevolence but will be able  create riches through innovative job creation, production and processing of local materials into finished products.

                        Lead specializes in organizational leadership and entrepreneurship, business studies, theology and marriage counselling from the diploma to the masters level. Welcome to be part of LEAD.
                    </p>
                    <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">LeaderShip</h4>
